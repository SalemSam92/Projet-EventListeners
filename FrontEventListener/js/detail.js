//affichage d'un évènement par son id
...
async function EventDetail() {
  ...
  document.getElementById("description").textContent = currentEvent.description;
...
document.addEventListener("DOMContentLoaded", () => {
  if (document.body.id === "event-detail") {
    EventDetail();
  }
});
...
//modification d'un évènement patch
